...
"""Resource feedback service tasks."""
...
def send_notification_email():
    ...
    comment_service = current_comments.resource_feedback_service

    notify_comments(record_service, comment_service, "resource", "feedback message")
